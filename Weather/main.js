        ...
        .then(function (data) {
          ...
          fetch(
            ...
            .then((data) => {
              ...
              // 아이콘 바인딩 시작
              let 템플릿 = [
                `<img src="./images/${weatherIcon2[날씨[0]]}.png"></img>`,
                `<img src="./images/${weatherIcon2[날씨[1]]}.png"></img>`,
                `<img src="./images/${weatherIcon2[날씨[2]]}.png"></img>`,
                `<img src="./images/${weatherIcon2[날씨[3]]}.png"></img>`,
                `<img src="./images/${weatherIcon2[날씨[4]]}.png"></img>`,
              ];
              for (let i = 1; i < 6; i++) {
                document
