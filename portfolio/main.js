...
// 로드되면 비주얼 텍스트 등장
setTimeout(() => {
  document.querySelectorAll(".sub_content")[0].style.opacity = 1;
  document.querySelectorAll(".sub_content")[0].style.marginLeft = "20px";
}, 3000);
setTimeout(() => {
  document.querySelectorAll(".line")[0].style.width = "200px";
}, 4000);
setTimeout(() => {
  document.querySelectorAll(".sub_content2")[0].style.opacity = 1;
  document.querySelectorAll(".sub_content2")[0].style.marginRight = "20px";
}, 5000);
document.querySelectorAll(".main_text");
for (let i = 0; i < 9; i++) {
  setTimeout(() => {
    document.querySelectorAll(".main_text")[i].style.color = "white";
  }, `1${i}00`);
}
setTimeout(() => {
  $(".main_text").css("text-shadow", " 0 0 20px rgba(255, 255, 255, 0.7)");
}, 1800);
setTimeout(() => {
  document.querySelectorAll(".background")[0].style.transform = "scale(1.0)";
}, 100);
