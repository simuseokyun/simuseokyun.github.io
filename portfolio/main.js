...
document.querySelectorAll(".darkmode")[0].addEventListener("click", () => {
  if (darkCount == 1) {
    ...
    document.querySelectorAll(".visual")[0].style.background = "#bbd7db";
    document.querySelectorAll(".visual_content")[0].style.color = "green";
    ...
    document.querySelectorAll(".visual_content")[0].style.color = "orange";
